...
public class ReportEntryCategory 
{
	 ...
	 * @param orderSum
	 */
	public ReportEntryCategory(String menuCategoryName,
			long orderCount, BigDecimal orderSum) {
		this.menuCategoryName = menuCategoryName;
		this.orderCount = orderCount;
		this.orderSum = orderSum;
	}
	public ReportEntryCategory()
	{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReportEntryCategory other = (ReportEntryCategory) obj;
